function UnityProgress (dom) {
	...
	backgroundImage.src = "TemplateData/fullscreenimage2.jpg"; 
	backgroundImage.style.position = "absolute";
    backgroundImage.style.zIndex = "-1";
	parent.appendChild(backgroundImage);
	...
	this.Update = function() {
		...
		backgroundImg.src = this.backgroundImage.src;

		this.backgroundImage.style.top = '0px';
		this.backgroundImage.style.left = '0px';
		this.backgroundImage.style.width = '100%';
		this.backgroundImage.style.height = '90%';
